  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Get in touch with MURYNA QABE LTD for construction inquiries, quotes, and support." />
      </Head>
      <main className="relative min-h-screen bg-[#0f172a] overflow-x-hidden">
        ...
        {/* Hero Section */}
        <section className="relative z-10 min-h-[55vh] flex items-center justify-center text-center">
          <motion.div
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-6 pt-6 md:pt-8">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-gray-300 text-sm">Mon-Fri: 8am-5pm</span>
                </div>
                <div className="flex items-center justify-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 md:gap-8">
              {galleryImages.map((img, idx) => (
                <div
                  ...
                  data-animation={idx === 0 ? "fade-left" : idx === 1 ? "zoom-in" : "fade-right"}
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-full group-hover:translate-y-0 transition duration-500 bg-gradient-to-t from-black to-transparent">
        ...
        {/* Google Map */}
        <div className="relative z-10 w-full h-64 md:h-[450px]">
        ...
        <div className="bg-amber-500 py-12 md:py-16 text-center scroll-reveal" data-animation="zoom-in">
          <div className="container mx-auto">
            ...
            <a href="mailto:sales@murynaqabe.co.uk" className="inline-block bg-slate-900 text-white font-bold px-7 py-3 rounded-full hover:bg-slate-800 transition shadow-lg">
              Request Free Quote
            </a>
          </div>
        </div>
